...
public class Config {
	...
	// RESOURCE CARD DECK
	public static final Map<Resource, Integer> INITIAL_RESOURCE_CARDS_BANK = Map.of(Resource.WOOD, 19, Resource.CLAY,
			19, Resource.WOOL, 19, Resource.GRAIN, 19, Resource.STONE, 19);
	 ...
	 */
	public enum Land {
		FOREST(Resource.WOOD), MEADOW(Resource.WOOL), GRAINFIELD(Resource.GRAIN), MOUNTAIN(Resource.STONE),
		CLAYSOIL(Resource.CLAY), WATER("~~"), DESERT("--");
